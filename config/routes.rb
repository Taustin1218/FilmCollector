...
# URL to webpage view is requested.
Rails.application.routes.draw do
  # When a get request is made for the actors URL,
  # Rails envokes the index ethod in the actors Ruby controlled class.
  ...
  get "movieratings" => "movieratings#index"
  post "movieratings" => "movieratings#create"
end
